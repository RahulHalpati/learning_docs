...
|---|--------|------------------------|
| 01 | [What LangChain & RAG are](01_what_is_langchain_and_rag.md) | What problem does each solve, and how do they fit together? |
| 02 | [Environment setup](02_environment_setup.md) | What do I install, and which LLM should I use? |
| 03 | [Your first chat model](03_your_first_chat_model.md) | How do I actually call an LLM from Python? |
