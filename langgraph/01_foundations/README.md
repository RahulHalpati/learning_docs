...
| 01-3 | [Environment setup](03_environment_setup.md) | How do I pin versions and pick a chat model? |
...
- Wire a chat model into a graph via one `get_model()` helper (`ChatOpenAI` by default, `ChatOllama` as a free local swap).
