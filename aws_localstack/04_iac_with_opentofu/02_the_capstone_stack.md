# 04-2 · The linkstash-cloud stack

> **Level:** Intermediate · **Prerequisites:** [04-1 The aws provider against Floci](01_aws_provider_against_floci.md)
...
```bash
docker run -d --name floci -p 4566:4566 floci/floci:latest   # up
...
docker rm -f floci                # stop Floci (state is ephemeral anyway)
```
...
**→ Next: [05-1 · Testing with Floci](../05_testing_and_ci/01_testing_with_floci.md)**
