# 05-1 · Config & secrets — Secrets Manager & SSM Parameter Store

> **Level:** Intermediate · **Prerequisites:** [02-2 DynamoDB](../02_core_services/02_dynamodb.md)
...
Parameter Store** (for plain config) — both free in Community, and both now wired
into the capstone.
...
**→ Next: [05-2 · Events & orchestration](02_eventbridge_and_stepfunctions.md)**
